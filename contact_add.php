            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body m-4">
                   <div class="row h-100 align-items-center justify-content-center">
                       <div class="col-12">
                           <div class="mb-5">
                               <h4 class="mb-3 text-center text-info" style="font-weight: 600"><i class="feather-users me-2" style="font-weight: 600"></i> Create Contact</h4>
                       ...
                       <div class="col-12 col-md-5">
                           ...
                           <form action="" method="post" enctype="multipart/form-data">
                               <div class="mb-3">
                                   ...
                                   <input type="text" id="name" name="name" value="<?php echo textFilter(oldData('name')); ?>" class="form-control" aria-describedby="passwordHelpBlock">
                               ...
                               <div class="mb-3">
                                   ...
                                   <input type="text" id="phone" name="phone" value="<?php echo textFilter(oldData('phone')); ?>" class="form-control">
                               ...
                               <div class="mb-3">
                                   ...
                                   <input type="email" id="email" name="email" value="<?php echo textFilter(oldData('email')); ?>" class="form-control">
